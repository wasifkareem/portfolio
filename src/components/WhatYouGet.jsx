...
export default function WhatYouGet() {
  return (
    <section id="deliverables" className="py-24 md:py-32 bg-white">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <AnimatedSection className="lg:col-span-7 lg:pr-12">
            ...
            <h2 className="text-3xl md:text-5xl font-semibold leading-snug md:leading-tight tracking-tight text-primary">
              Everything your SaaS website needs to{' '}
              <span className="text-accent">ship faster.</span>
            </h2>
            <p className="mt-6 text-lg text-secondary">
              No scope creep. No surprises. A complete migration package —
              everything your B2B SaaS site needs to outperform the competition.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.2} className="lg:col-span-5">
            ...
            <div className="flex items-baseline gap-3 mb-8">
              <span className="text-5xl md:text-6xl font-extrabold text-primary">3 Weeks</span>
              <span className="text-lg text-secondary font-medium">to launch</span>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-border">
              <p className="text-sm text-secondary">
                ...
                I offer flexible monthly retainers for continuous development — 
