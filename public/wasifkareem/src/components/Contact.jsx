      ...
      <div className="max-w-[1450px] mx-auto px-6">
        <AnimatedSection>
          <div className="max-w-2xl">
            ...
            <a
              href="mailto:hello@wasifkareem.com"
              className="mt-8 inline-flex items-center gap-3 px-8 py-4 bg-primary text-white text-base font-semibold hover:bg-accent transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
              hello@wasifkareem.com
            </a>

            <div className="mt-8 flex gap-5">
              <a
                href="https://twitter.com/wasifkareem"
                target="_blank"
              ...
              <a
                href="https://github.com/wasifkareem"
                target="_blank"
                rel="noopener noreferrer"
                className="text-secondary hover:text-primary transition-colors"
                aria-label="GitHub"
